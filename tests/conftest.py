...
@pytest.fixture
def user(db):
    return User.objects.create_user(username="consultant1", password="testpass123", level=2)


@pytest.fixture
def other_user(db):
    return User.objects.create_user(username="consultant2", password="testpass123", level=2)


@pytest.fixture
def other_org_user(db):
    return User.objects.create_user(username="outsider", password="testpass123", level=2)
