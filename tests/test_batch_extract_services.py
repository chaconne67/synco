...
from batch_extract.services.ingest import _load_extracted_json
from batch_extract.services.request_builder import (
    build_request_line,
...
def test_ingest_job_results_supports_parallel_workers(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "batch_extract.services.ingest._handle_result_payload",
