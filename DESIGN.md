...
### Button (Primary)
```
bg-primary text-white font-semibold py-3 px-5 rounded-xl text-sm
```
hover: `hover:bg-primary-dark`

### Button (Secondary)
```
border border-gray-200 text-gray-700 font-semibold py-3 px-5 rounded-xl text-sm
```
...
### Toast (Success)
```
fixed bottom-24 left-1/2 -translate-x-1/2 bg-gray-900 text-white px-5 py-3 rounded-xl text-sm
```
3초 후 자동 사라짐.
