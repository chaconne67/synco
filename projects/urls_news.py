...
urlpatterns = [
    ...
    path(
        "sources/<uuid:pk>/edit/",
        views_news.news_source_update,
        name="news_source_update",
    ),
    path(
        "sources/<uuid:pk>/delete/",
        views_news.news_source_delete,
        name="news_source_delete",
    ),
    path(
        "sources/<uuid:pk>/toggle/",
        views_news.news_source_toggle,
        name="news_source_toggle",
    ),
]
